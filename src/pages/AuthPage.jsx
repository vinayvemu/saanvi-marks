    ...
    <main className="min-h-screen bg-onyx-950 flex items-center justify-center px-6 pt-24 pb-16">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-10">
          ...
          <span className="badge-gold mb-4 inline-block">Welcome</span>
          <h1 className="font-serif text-3xl text-cream leading-tight">
            Sign in to <span className="text-gold-400 italic">Saanvi Marks</span>
          </h1>
        ...
        <div className="bg-onyx-900 border border-onyx-700 p-8">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-4 py-3.5 border border-onyx-600
                       text-onyx-200 hover:border-gold-600 hover:text-cream
                       active:scale-[0.99] transition-all duration-150 disabled:opacity-50"
          >
            {loading ? (
              <span className="w-4 h-4 border-2 border-onyx-600 border-t-gold-500 rounded-full animate-spin" />
            ) : (
          ...
          {/* ── Email / Password login — commented out, uncomment to re-enable ──
          <div className="luxury-divider text-[10px] tracking-luxury uppercase text-onyx-500 my-6">
            or
          </div>
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                {mode === 'login' && (
                  <button type="button" className="text-[11px] text-gold-600 hover:text-gold-400 transition-colors"
                    onClick={() => {}}>
                    Forgot password?
                  </button>
                )}
        ...
        <p className="text-center text-[11px] text-onyx-600 mt-6 leading-relaxed">
